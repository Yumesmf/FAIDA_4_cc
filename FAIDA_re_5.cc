...
// pass2 . insert csv data into struct
...
// pass1 . read csv, get the number of columns and records
...
void HLL(CSVDATA csvData_1, CSVDATA csvData_1_hash, CSVDATA csvData_2, CSVDATA csvData_2_hash)
{
    ...
    while (i < csvData_1_hash.record_count)
    {
        ...
        // csvData_1_hash_HLL.data.push_back(hash_hll_1);
        // hash_hll_1.clear();
        i++;
    }
    ...
    // for (int m = 0; m < csvData_1_hash.record_count; m++)
    // {
    //     for (int c = 0; c < csvData_1_hash.col_count; c++)
    //     {
    //         cout << csvData_1_hash_HLL.data[m][c] << endl;
    //     }
    // }

    // for (int m = 0; m < hash_hll_1.size(); m++)
    // {
    //     cout << hash_hll_1[m] << endl;
    // }
    // cout << endl;
    // for (int m = 0; m < hash_hll_2.size(); m++)
    // {
    //     cout << hash_hll_2[m] << endl;
    // }
    ...
    for (int i = 0; i < record.size(); i++)
    {
        ...
        {
            cout << csvData_1.data[record[i]][j] << endl;
        }
    }
}
